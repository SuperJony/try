...
```sh
cd '/path/to/tries' && \
  test -d 'dir-name-1' && /bin/rm -rf 'dir-name-1' && \
  test -d 'dir-name-2' && /bin/rm -rf 'dir-name-2' && \
...
cd '/home/user/tries' && \
  test -d '2025-11-29-old-project' && /bin/rm -rf '2025-11-29-old-project' && \
  test -d '2025-11-28-abandoned' && /bin/rm -rf '2025-11-28-abandoned' && \
